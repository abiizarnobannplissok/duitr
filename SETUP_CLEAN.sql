-- ============================================
-- DUITR - CLEAN INSTALL (Drop Everything First)
-- ============================================

-- STEP 1: Drop all tables (cascade will drop policies too)
...
SELECT setval('categories_category_id_seq', 22);
...
-- DONE!
SELECT 'SUCCESS! Created 4 tables and 21 categories' AS result;
